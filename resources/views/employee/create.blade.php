            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <b>{{ __('Create Employee Details') }} </b>
                        ...
                        <form action="{{ route('employee.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mt-2">
                                ...
                                <input type="text" class="form-control" id="first_name" name="first_name"
                                    placeholder="Enter employee first name" value="{{ old('first_name') }}">
                            ...
                            <div class="form-group mt-2">
                                ...
                                <input type="text" class="form-control" id="last_name" name="last_name"
                                    placeholder="Enter employee first name" value="{{ old('last_name') }}">
                            ...
                            <div class="form-group mt-2">
                                ...
                                <input type="email" class="form-control" id="email" name="email"
                                    placeholder="Enter employee email" value="{{ old('email') }}">
                                @if ($errors->has('email'))
                            ...
                            <div class="form-group mt-2">
                                <label for="phone" class="text-capitalize">phone <span
                                        class="text-danger">*</span></label>
